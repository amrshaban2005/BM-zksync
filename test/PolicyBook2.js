...
contract("PolicyBook2", async (accounts) => {
  ...
  before("setup", async () => {
    ...
    await rewardsGeneratorMock.__RewardsGenerator_init(Networks.ETH);
  ...
  describe("getWithdrawalStatus", async () => {
    ...
    it("should return READY status if withdrawal is possible", async () => {
      ...
      await increaseTime(withdrawalPeriod.plus(timestamp).toString());
    ...
    it("should return EXPIRED status if withdrawal not possible, withdrawal expire period expired", async () => {
      ...
      await increaseTime(withdrawalPeriod.plus(withdrawalExpirePeriod).plus(10).toString());
  ...
  describe("requestWithdrawal", async () => {
    ...
    it.only("should correctly announce withdrawal", async () => {
      const timestamp = await getBlockTimestamp();
    ...
    it("should announce withdrawal if withdrawal status EXPIRED and previous request less than new", async () => {
      ...
      await increaseTime(expiryDate.toString());
    ...
    it("should correctly requestWithdrawal multiple times", async () => {
      ...
      await increaseTime(withdrawalPeriod.plus(timestamp).plus(withdrawalExpirePeriod).plus(10).toString());
  ...
  describe("staking modifier", async () => {
    ...
    beforeEach("setup", async () => {
      ...
      await policyBookMock.__PolicyBook_init(NOTHING, ContractType.CONTRACT, "PBM", "PBM");
